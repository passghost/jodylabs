-- Minimal Supabase setup for boat system
-- Run this if you're getting "relation does not exist" errors

-- 1. Create player_stats table (required for boat system)
...
DO $
BEGIN
    RAISE NOTICE 'Minimal boat system database setup complete!';
    RAISE NOTICE 'Tables created: player_stats, player_boats, player_inventory';
    RAISE NOTICE 'You can now run the full boat system without errors.';
END $;